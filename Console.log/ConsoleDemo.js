...
console.log("subst it's like in C language. substring list integer= %d,string=%s. ", 1,"hello","p3Parameter",function(){var p4 =1});
console.log("subst Check for hyperlink: %o", "www.buidu.com");
console.log("subst Check for expandable JavaScript Object: %O", "www.buidu.com");
console.log("subst Check for floating-point value: %f, %f", 1.23,"1.23");
...
console.log("%cMy stylish message", "color: red; font-style: italic");//加CSS样式
